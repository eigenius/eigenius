...
- `docs/papers/eigenius-institutions.tex` *(deleted in `0a104d3` with the rest of `docs/papers/`)* — the high-level published narrative; D14 is the implementation contract for it.
