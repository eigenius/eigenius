...
- **[D3 program model](d3-program-model.md):** agent operations are Programs; the dependent-function shape and Mini-TT term grammar are non-negotiable. `capability_level` on Components is sourced from D3 §6.3.
