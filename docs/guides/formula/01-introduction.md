...
|---|---|---|
| **Mini-TT fragment** | Inside the kernel's type theory | A subset of Mini-TT `Exp` lifted onto the chain as an inductive type. Six constructors mirror Mini-TT one-for-one. |
...
on the chain. The first surface (Mini-TT fragment) is the kernel's
...
coming from Mini-TT, ATP / SMT, or symbolic-algebra backgrounds:

- **It's not the full Mini-TT.** The chain-resident form is a small
  ...
  full Mini-TT lives in [`kernel/src/nbe/`](../../../kernel/src/nbe/) and
  is not user-facing.
...
| Constructor | Args (Mini-TT view) | Concrete example |
|---|---|---|
...
Next: **[2. The Mini-TT fragment →](02-mini-tt-fragment.md)**
