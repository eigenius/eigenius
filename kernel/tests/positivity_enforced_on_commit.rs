...
/// Girard's paradox follows. This is the check that forced `justification:Grounds` from `Type 0` to
/// `Type 2` — it binds `T : Type 1` in `instantiate`, and nothing enforced the constraint before.
///
