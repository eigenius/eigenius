...
mod tests {
    ...
    fn sized_codata_with_bounded_binder_from_esl() {
        ...
        let layer = build_layer_with_esl(
            ...
            codata ex:SizedBox(i : Size, A : Set) {
                get : A;
                shrink : {j < i} -> A;
            }
            "#,
    ...
    fn sized_types_end_to_end_esl_to_check() {
        ...
        //   1. ESL source declares `data ex:SizedNat(i : Size)`
