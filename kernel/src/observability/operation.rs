...
pub const RPC_START_REINDEX: &str = "kernel.rpc.start_reindex";
pub const RPC_START_SWEEP: &str = "kernel.rpc.start_sweep";
pub const RPC_DELETE_TASK: &str = "kernel.rpc.delete_task";
pub const RPC_PRUNE_TASKS: &str = "kernel.rpc.prune_tasks";
