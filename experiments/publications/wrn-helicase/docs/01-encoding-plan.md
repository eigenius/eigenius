...
Each node is a candidate `justification:Sentence` whose `justification:Term` cites the Observed/Derived/Declared resources beneath it. `C-MAIN` is the paper's thesis; its justification is the composition of the whole graph.
