...
- 🟩 **Verified** `#2E9D5D` — kernel-checked reasoning conclusions (`justification:Conclusion` that Holds); the bold-green apex is the final claim (itself a verified conclusion).
