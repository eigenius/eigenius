...
`concl_p53_activation` justification:Sentence (chain/08-phase3-invivo-mechanism.esl) discharges that witness — a reproduced-external
...
under a ProgramTrace → IsDerivedAs witness. The `concl_dsb_foci` justification:Sentence (chain/08-phase3-invivo-mechanism.esl)
