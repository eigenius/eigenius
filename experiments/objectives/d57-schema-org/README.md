...
| 2 | [chain/01-discipline.esl](chain/01-discipline.esl) | milestone **m1** — the mapping discipline, a Declared rule + the `justification:Conclusion` that discharges it (verdict: **Holds**) |
